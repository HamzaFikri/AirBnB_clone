...
class TestUser(unittest.TestCase):
    ...
    def test_last_name_public(self):
        ...
        my_model1 = User()
        my_model1.last_name = "AlxHolberton"
        self.assertEqual(my_model1.last_name, "AlxHolberton")

    def test_email_public(self):
        msj = "Last_name isn't public"
        my_model1 = User()
        my_model1.email = "airbnb@mail.com"
        self.assertEqual(my_model1.email, "airbnb@mail.com")
